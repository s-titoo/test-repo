...
```
## Installing package into 'C:/Users/Titoo/Documents/R/win-library/3.6'
## (as 'lib' is unspecified)
```

```
## also installing the dependencies 'ps', 'processx', 'callr', 'prettyunits', 'backports', 'desc', 'pkgbuild', 'rprojroot', 'rstudioapi', 'pkgload', 'praise', 'sys', 'testthat', 'colorspace', 'askpass', 'utf8', 'gtable', 'isoband', 'rlang', 'withr', 'sp', 'Rcpp', 'farver', 'labeling', 'munsell', 'R6', 'RColorBrewer', 'viridisLite', 'lifecycle', 'ellipsis', 'assertthat', 'pkgconfig', 'tidyselect', 'BH', 'plogr', 'curl', 'jsonlite', 'openssl', 'cli', 'crayon', 'fansi', 'pillar', 'vctrs', 'ggplot2', 'RgoogleMaps', 'png', 'plyr', 'rjson', 'jpeg', 'digest', 'scales', 'dplyr', 'bitops', 'httr', 'purrr', 'tibble', 'tidyr'
```
...
## 	C:\Users\Titoo\AppData\Local\Temp\RtmpMlX1BE\downloaded_packages
```
...
```
## also installing the dependencies 'DBI', 'abind', 'e1071', 'sf', 'lwgeom', 'stars', 'units', 'raster', 'classInt', 'dichromat', 'XML'
```
...
```
## also installing the dependencies 'rematch', 'htmltools', 'base64enc', 'tinytex', 'generics', 'reshape2', 'clipr', 'cellranger', 'progress', 'fs', 'rmarkdown', 'whisker', 'selectr', 'broom', 'dbplyr', 'forcats', 'haven', 'hms', 'lubridate', 'modelr', 'readr', 'readxl', 'reprex', 'rvest', 'xml2'
```
...
```
## also installing the dependencies 'lazyeval', 'gridExtra', 'crosstalk', 'htmlwidgets', 'viridis', 'leaflet.providers'
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=The+Angel,+Bermondsey&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```

```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=The+Churchill+Arms,+Notting+Hill&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```

```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=The+Auld+Shillelagh,+Stoke+Newington&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```

```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=The+Sekforde,+Clerkenwell&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```

```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=The+Dove,+Hammersmith&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```

```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=The+Crown+and+Sugar+Loaf,+Fleet+Street&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```

```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=The+Lamb,+Holborn&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```

```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=Prince+of+Greenwich,+Greenwich&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```

```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=Ye+Olde+Mitre,+Hatton+Garden&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```

```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=The+Glory,+Haggerston&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```

```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=The+Blue+Posts,+Soho&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```

```
## Source : https://maps.googleapis.com/maps/api/geocode/json?address=The+Old+Bank+of+England,+Fleet+Street&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##                                      Pubs        lon      lat          type loctype
## 1                   The Angel, Bermondsey -0.0590456 51.50064           bar rooftop
## 2        The Churchill Arms, Notting Hill -0.1948010 51.50691           bar rooftop
## 3    The Auld Shillelagh, Stoke Newington -0.0794564 51.56205           bar rooftop
## 4               The Sekforde, Clerkenwell -0.1044597 51.52437 establishment rooftop
## 5                   The Dove, Hammersmith -0.2348502 51.49050           bar rooftop
## 6  The Crown and Sugar Loaf, Fleet Street -0.1049939 51.51402           bar rooftop
## 7                       The Lamb, Holborn -0.1190473 51.52309           bar rooftop
## 8          Prince of Greenwich, Greenwich -0.0099570 51.47619           bar rooftop
## 9            Ye Olde Mitre, Hatton Garden -0.1073185 51.51841           bar rooftop
## 10                  The Glory, Haggerston -0.0770533 51.53620           bar rooftop
## 11                   The Blue Posts, Soho -0.1326110 51.51113           bar rooftop
## 12  The Old Bank of England, Fleet Street -0.1114818 51.51390           bar rooftop
##                                                               address
## 1                          101 bermondsey wall e, london se16 4nb, uk
## 2             119 kensington church st, kensington, london w8 7ln, uk
## 3  105 stoke newington church st, stoke newington, london n16 0ud, uk
## 4                     34 sekforde st, farringdon, london ec1r 0ha, uk
## 5                       19 upper mall, hammersmith, london w6 9ta, uk
## 6                                    98 fleet st, london ec4y 1dh, uk
## 7                  94 lamb's conduit st, holborn, london wc1n 3lz, uk
## 8                       72 royal hill, greenwich, london se10 8rt, uk
## 9                      1 ely ct, ely pl, holborn, london ec1n 6sj, uk
## 10                    281 kingsland rd, haggerston, london e2 8as, uk
## 11                         28 rupert st, west end, london w1d 6dj, uk
## 12                         194 fleet st, holborn, london ec4a 2lt, uk
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.5006419,-0.0590456&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   101 Bermondsey Wall E, London SE16 4NB, UK
```

```
##   4NA,, Bermondsey Wall E, London SE16 4NB, UK
```

```
##   1 Fulford St, London SE16 4NW, UK
```

```
##   Bermondsey Wall E, London SE16 4NA, UK
```

```
##   Bermondsey Wall E, The Angel, London SE16 4NB, UK
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.5069117,-0.194801&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   117 Kensington Church St, Kensington, London W8 7LN, UK
```

```
##   87 Campden St, Kensington, London W8 7EN, UK
```

```
##   1 Campden St, Kensington, London W8, UK
```

```
##   32-1 Campden St, Kensington, London W8, UK
```

```
##   Kensington Church St, Kensington, London W8 7LN, UK
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.5620538,-0.0794564&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   103 Stoke Newington Church St, Stoke Newington, London N16 0UD, UK
```

```
##   105 B104, Stoke Newington, London N16 0UD, UK
```

```
##   103-113 B104, Stoke Newington, London N16 0UD, UK
```

```
##   Stoke Newington Church St, Stoke Newington, London N16 0UD, UK
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.5243685,-0.1044597&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   34 Sekforde St, Farringdon, London EC1R 0HA, UK
```

```
##   34 Sekforde St, Farringdon, London EC1R, UK
```

```
##   5-7 Woodbridge St, Farringdon, London EC1R, UK
```

```
##   Sekforde St, Farringdon, London EC1R 0HD, UK
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.4905047,-0.2348502&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   19 Upper Mall, Hammersmith, London W6 9TA, UK
```

```
##   24 Upper Mall, Hammersmith, London W6 9TA, UK
```

```
##   14 Upper Mall, Hammersmith, London W6, UK
```

```
##   32-24 Upper Mall, Hammersmith, London W6, UK
```

```
##   Rivercourt Rd, London W6 9TF, UK
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.5140163,-0.1049939&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   98 Fleet St, London EC4Y 1DH, UK
```

```
##   97 Bride Ln, London EC4Y 1DE, UK
```

```
##   30 Bride Ln, London EC4Y 1DE, UK
```

```
##   26 Bride Ln, London EC4Y 1DE, UK
```

```
##   Fleet St, London EC4Y 1DE, UK
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.5230876,-0.1190473&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   94 Lamb's Conduit St, Holborn, London WC1N 3LZ, UK
```

```
##   6 Guilford Pl, Holborn, London WC1N 1EA, UK
```

```
##   14 Long Yard, Holborn, London WC1N, UK
```

```
##   Guilford Pl, Holborn, London WC1N, UK
```

```
##   Lamb's Conduit St, Holborn, London WC1N 3LZ, UK
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.476194,-0.009957&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   Prince Albert, 72 Royal Hill, Greenwich, London SE10 8RT, UK
```

```
##   74 Royal Hill, Greenwich, London SE10 8RT, UK
```

```
##   72 Royal Hill, Greenwich, London SE10, UK
```

```
##   84-72 Royal Hill, Greenwich, London SE10, UK
```

```
##   Royal Hill, Greenwich, London SE10 8RF, UK
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.5184089,-0.1073185&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   1 Ely Ct, Ely Pl, Holborn, London EC1N 6SJ, UK
```

```
##   10 Ely Pl, Holborn, London EC1N 6RY, UK
```

```
##   1 Ely Ct, Holborn, London EC1N 6RY, UK
```

```
##   Ely Ct, Holborn, London EC1N 6RY, UK
```

```
##   Ely Pl, Holborn, London EC1N 6SJ, UK
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.5362036,-0.0770533&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   281A Kingsland Rd, Haggerston, London E2 8AS, UK
```

```
##   4, 281A Kingsland Rd, Haggerston, London E2 8AS, UK
```

```
##   281 Kingsland Rd, Haggerston, London N1 5RL, UK
```

```
##   1 Mill Row, Whitmore Estate, London N1, UK
```

```
##   1 Orsman Rd, Haggerston, London N1, UK
```

```
##   Mill Row, London N1 5RL, UK
```

```
##   Whitmore Estate, London N1, UK
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.511127,-0.132611&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   28 Rupert St, West End, London W1D 6DJ, UK
```

```
##   30 Rupert St, West End, London W1D 6DL, UK
```

```
##   28 Rupert St, West End, London W1D, UK
```

```
##   4 Rupert Ct, West End, London W1D, UK
```

```
##   Rupert St, West End, London W1D 6DJ, UK
```
...
```
## Source : https://maps.googleapis.com/maps/api/geocode/json?latlng=51.5138962,-0.1114818&key=xxx-9_FLmpOi3uAJMBcy-Xr52R70EzD5uo
```
...
```
##   194 Fleet St, Holborn, London EC4A 2LT, UK
```

```
##   126 Chancery Ln, Holborn, London WC2A, UK
```

```
##   10 Fleet St, Holborn, London EC4A 2LT, UK
```

```
##   Fleet St, Holborn, London EC4A 2AH, UK
```

```
##   Holborn, London WC2A, UK
```
...
```
## Warning in FUN(X[[i]], ...): No results found for "The Glory, Haggerston bar".
```
...
##                                                               address   city         phone
## 1                          101 Bermondsey Wall E, London SE16 4NB, UK London 020 7394 3214
## 2             119 Kensington Church St, Kensington, London W8 7LN, UK London 020 7727 4242
## 3  105 Stoke Newington Church St, Stoke Newington, London N16 0UD, UK London 020 7249 5951
## 4                     34 Sekforde St, Farringdon, London EC1R 0HA, UK London 020 7250 0010
## 5                       19 Upper Mall, Hammersmith, London W6 9TA, UK London 020 8748 9474
## 6                                    98 Fleet St, London EC4Y 1DH, UK London          <NA>
## 7                  94 Lamb's Conduit St, Holborn, London WC1N 3LZ, UK London 020 7405 0713
## 8                       72 Royal Hill, Greenwich, London SE10 8RT, UK London  07940 596381
## 9                      1 Ely Ct, Ely Pl, Holborn, London EC1N 6SJ, UK London 020 7405 4751
## 10                    281 Kingsland Rd, Haggerston, London E2 8AS, UK London 020 7684 0794
## 11                         28 Rupert St, West End, London W1D 6DJ, UK London  07921 336010
## 12                         194 Fleet St, Holborn, London EC4A 2LT, UK London 020 7430 2255
##                                                                                                                        web page
...
## 3                                                                                               http://theauldshillelagh.co.uk/
...
## 1                          101 Bermondsey Wall E, London SE16 4NB, UK London United Kingdom
## 2             119 Kensington Church St, Kensington, London W8 7LN, UK London United Kingdom
## 3  105 Stoke Newington Church St, Stoke Newington, London N16 0UD, UK London United Kingdom
## 4                     34 Sekforde St, Farringdon, London EC1R 0HA, UK London United Kingdom
## 5                       19 Upper Mall, Hammersmith, London W6 9TA, UK London United Kingdom
## 6                                    98 Fleet St, London EC4Y 1DH, UK London United Kingdom
## 7                  94 Lamb's Conduit St, Holborn, London WC1N 3LZ, UK London United Kingdom
## 8        Prince Albert, 72 Royal Hill, Greenwich, London SE10 8RT, UK London United Kingdom
## 9                      1 Ely Ct, Ely Pl, Holborn, London EC1N 6SJ, UK London United Kingdom
## 10                   281A Kingsland Rd, Haggerston, London E2 8AS, UK London United Kingdom
## 11                         28 Rupert St, West End, London W1D 6DJ, UK London United Kingdom
## 12                         194 Fleet St, Holborn, London EC4A 2LT, UK London United Kingdom
```
...
## 1                  The Angel, Bermondsey        51.50063675 -0.05906114651162744
## 2       The Churchill Arms, Notting Hill 51.506872200000004 -0.19482219080740487
## 3   The Auld Shillelagh, Stoke Newington         51.5620186           -0.0794532
## 4              The Sekforde, Clerkenwell         51.5242876 -0.10442487273234387
## 5                  The Dove, Hammersmith 51.490508500000004 -0.23485741509400304
## 6               The Crown and Sugar Loaf         51.5140324           -0.1050005
## 7                      The Lamb, Holborn         51.5230437 -0.11903102762686923
## 8         Prince of Greenwich, Greenwich         51.4762278           -0.0098418
## 9                          Ye Olde Mitre         51.5184299 -0.10738277040280805
## 10                 The Glory, Haggerston               <NA>                 <NA>
## 11                  The Blue Posts, Soho         51.5128957 -0.13943685289494165
## 12 The Old Bank of England, Fleet Street         51.5139117 -0.11146836718248274
##                                                                                                                                                                         address
## 1                      The Angel, 101, Bermondsey Wall East, Bermondsey Spa, Bermondsey, London Borough of Southwark, London, Greater London, England, SE16 4TU, United Kingdom
## 2                            The Churchill Arms, Campden Street, Notting Hill, Royal Borough of Kensington and Chelsea, London, Greater London, England, W8 7EL, United Kingdom
## 3  The Auld Shillelagh, 105, Stoke Newington Church Street, South Hornsey, Stoke Newington, London Borough of Hackney, London, Greater London, England, N16 0UD, United Kingdom
...
```
##                             search_query                pub_name                   street_name
## 1                  The Angel, Bermondsey               The Angel          Bermondsey Wall East
## 2       The Churchill Arms, Notting Hill      The Churchill Arms                Campden Street
## 3   The Auld Shillelagh, Stoke Newington     The Auld Shillelagh Stoke Newington Church Street
## 4              The Sekforde, Clerkenwell            The Sekforde             Woodbridge Street
## 5                  The Dove, Hammersmith                The Dove                    Upper Mall
## 6               The Crown and Sugar Loaf      Crown & Sugar Loaf                    Bride Lane
## 7                      The Lamb, Holborn                The Lamb         Lamb's Conduit Street
## 8         Prince of Greenwich, Greenwich The Prince Of Greenwich                    Royal Hill
## 9                          Ye Olde Mitre           Ye Olde Mitre                     Ely Place
## 10                 The Glory, Haggerston                    <NA>                          <NA>
## 11                  The Blue Posts, Soho          The Blue Posts                          <NA>
## 12 The Old Bank of England, Fleet Street The Old Bank of England                  Fleet Street
##    house_number          suburb postcode state_district
## 1           101      Bermondsey SE16 4TU Greater London
## 2          <NA>    Notting Hill   W8 7EL Greater London
## 3           105 Stoke Newington  N16 0UD Greater London
## 4          <NA>     Clerkenwell EC1R 0DG Greater London
## 5            19     Brook Green   W6 9TA Greater London
## 6            26          Temple EC4Y 8DT Greater London
## 7            94      Bloomsbury WC1N 3LZ Greater London
## 8            72            <NA> SE10 8RT Greater London
## 9          <NA>            <NA> EC1N 6SJ Greater London
## 10         <NA>            <NA>     <NA>           <NA>
## 11         <NA>            Soho  W1F 7PA Greater London
## 12          194          Temple EC4A 2LT Greater London
```
...
```
##                             search_query                                              website_1
## 1                  The Angel, Bermondsey                                                   <NA>
## 2       The Churchill Arms, Notting Hill             https://www.churchillarmskensington.co.uk/
## 3   The Auld Shillelagh, Stoke Newington                                                   <NA>
## 4              The Sekforde, Clerkenwell                                                   <NA>
## 5                  The Dove, Hammersmith                     https://www.dovehammersmith.co.uk/
## 6               The Crown and Sugar Loaf                                                   <NA>
## 7                      The Lamb, Holborn      https://www.youngs.co.uk/pub-detail.asp?PubID=421
## 8         Prince of Greenwich, Greenwich                https://www.theprinceofgreenwichpub.com
## 9                          Ye Olde Mitre                                                   <NA>
## 10                 The Glory, Haggerston                                                   <NA>
## 11                  The Blue Posts, Soho http://traditionalpubslondon.co.uk/blueposts/index.php
## 12 The Old Bank of England, Fleet Street                                                   <NA>
##    website_2                          website_3
## 1         NA                               <NA>
## 2         NA                               <NA>
## 3         NA                               <NA>
...
```
##                             search_query          phone_1 phone_2                           email_1
## 1                  The Angel, Bermondsey             <NA>      NA                              <NA>
## 2       The Churchill Arms, Notting Hill             <NA>      NA                              <NA>
## 3   The Auld Shillelagh, Stoke Newington             <NA>      NA                              <NA>
## 4              The Sekforde, Clerkenwell             <NA>      NA                              <NA>
## 5                  The Dove, Hammersmith             <NA>      NA                              <NA>
## 6               The Crown and Sugar Loaf             <NA>      NA                              <NA>
## 7                      The Lamb, Holborn             <NA>      NA                              <NA>
## 8         Prince of Greenwich, Greenwich +44 20 8692 6089      NA theprinceofgreenwichpub@gmail.com
## 9                          Ye Olde Mitre             <NA>      NA                              <NA>
## 10                 The Glory, Haggerston             <NA>      NA                              <NA>
## 11                  The Blue Posts, Soho             <NA>      NA                              <NA>
## 12 The Old Bank of England, Fleet Street   +44 2074302255      NA                              <NA>
##                               email_2
## 1                                <NA>
## 2                                <NA>
## 3                                <NA>
...
```
##                                     Pubs                pub_name                   street_name
## 1                  The Angel, Bermondsey               The Angel          Bermondsey Wall East
## 2       The Churchill Arms, Notting Hill      The Churchill Arms                Campden Street
## 3   The Auld Shillelagh, Stoke Newington     The Auld Shillelagh Stoke Newington Church Street
## 4              The Sekforde, Clerkenwell            The Sekforde             Woodbridge Street
## 5                  The Dove, Hammersmith                The Dove                    Upper Mall
## 6               The Crown and Sugar Loaf            Punch Tavern                    Bride Lane
## 7                      The Lamb, Holborn                The Lamb         Lamb's Conduit Street
## 8         Prince of Greenwich, Greenwich The Prince Of Greenwich                    Royal Hill
## 9                          Ye Olde Mitre           Ye Olde Mitre                     Ely Place
## 10                 The Glory, Haggerston                    <NA>                          <NA>
## 11                  The Blue Posts, Soho          The Blue Posts                          <NA>
## 12 The Old Bank of England, Fleet Street The Old Bank of England                  Fleet Street
##    house_number          suburb postcode state_district        country
## 1           101      Bermondsey SE16 4TU Greater London United Kingdom
## 2          <NA>    Notting Hill   W8 7EL Greater London United Kingdom
## 3           105 Stoke Newington  N16 0UD Greater London United Kingdom
## 4          <NA>     Clerkenwell EC1R 0DG Greater London United Kingdom
## 5            19     Brook Green   W6 9TA Greater London United Kingdom
## 6            30          Temple EC4Y 8DX Greater London United Kingdom
## 7            94      Bloomsbury WC1N 3LZ Greater London United Kingdom
## 8            72            <NA> SE10 8RT Greater London United Kingdom
## 9          <NA>            <NA> EC1N 6SJ Greater London United Kingdom
## 10         <NA>            <NA>     <NA>           <NA>           <NA>
## 11         <NA>            Soho  W1F 7PA Greater London United Kingdom
## 12          194          Temple EC4A 2LT Greater London United Kingdom
```
